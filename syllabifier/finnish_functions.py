...
#     's', 't', 'v', 'x', 'z', "'"])  # ' incl. for words like vaa'an
...
DIPHTHONGS = set([
    u'ai', u'ei', u'oi', u'äi', u'öi', u'au', u'eu', u'ou', u'ey', u'äy',
    u'öy', u'ui', u'yi', u'iu', u'iy', u'ie', u'uo', u'yö'])
CONSONANTS = set([
    u'b', u'c', u'd', u'f', u'g', u'h', u'j', u'k', u'l', u'm', u'n', u'p',
    u'q', u'r', u's', u't', u'v', u'x', u'z', u"'"
    ])  # ' incl. for words like vaa'an
...
# in a split syllable, the onset is the 0th element, the nucleus is the 1st,
# and the coda is the 2nd
class Syllable:
    onset = 0
    nucleus = 1
    coda = 2
...
# syllable weights in increasing order of weight, for purposes of deciding
# which syllable to stress in a sequence of two syllables
class Weight:
    CV = 0  # (C)V
    CVC = 1  # (C)VC+
    CVV = 2  # (C)VV+C*
